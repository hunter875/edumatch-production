...
@PreAuthorize("hasAuthority('ROLE_ADMIN')")  // Only ADMIN can access debug endpoints
public class DebugController {
    ...
    public ResponseEntity<?> debugJwt(@RequestHeader(value = "Authorization", required = false) String authHeader) {
        ...
        // Sanitized: don't expose token preview in production
        response.put("tokenPreview", "[REDACTED]");
        ...
        try {
            ...
            // Sanitized: don't expose internal exception details
