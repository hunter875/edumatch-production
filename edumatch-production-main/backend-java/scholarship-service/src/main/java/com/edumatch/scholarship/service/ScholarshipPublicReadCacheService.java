...
public class ScholarshipPublicReadCacheService {
    ...
    @Cacheable(
            ...
            key = "#id",
            unless = "#result == null || #result.data == null || #result.data.opportunity == null || !T(java.lang.Boolean).TRUE.equals(#result.data.opportunity.getIsPublic()) || #result.data.opportunity.getModerationStatus() != T(com.edumatch.scholarship.model.ModerationStatus).APPROVED"
    )
