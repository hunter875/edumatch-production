...
│                                                             │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐     │
│  │   FastAPI    │  │ Event Handler│  │   RabbitMQ   │     │
...
# Run RabbitMQ consumer (terminal 2)
...
docker-compose --profile workers up -d --scale matching-consumer=5 matching-consumer
```
...
# Check worker logs
docker-compose logs matching-consumer
```
