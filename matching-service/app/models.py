...
class ApplicantFeature(Base):
    ...
    preferred_funding_types = Column(ARRAY(String), nullable=True)
...
class OpportunityFeature(Base):
    ...
    eligible_majors = Column(ARRAY(String), nullable=True)
    eligible_nationalities = Column(ARRAY(String), nullable=True)
...
class RecommendationCache(Base):
    ...
    missing_information_json = Column(JSON, nullable=True)
    source_url = Column(Text, nullable=True)
    last_verified_at = Column(DateTime, nullable=True)
    score_type = Column(String(50), nullable=True)
    model_version = Column(String(100), nullable=True)
    corpus_version = Column(String(150), nullable=True)
    profile_version = Column(String(100), nullable=True)
    opportunity_version = Column(String(100), nullable=True)
